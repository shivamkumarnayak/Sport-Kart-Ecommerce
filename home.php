...
<body>
  ...
  <header id="home" class="header">
      ...
      <div class="navigation container">
        ...
        <div class="menu">
          ...
          <ul class="nav-list">
            ...
            <li class="nav-item">
              <a href="#contactus" class="nav-link scroll-link">Contact</a>
            </li>
            <li class="nav-item">
    ...
    <!-- Hero -->
    <img src="./images/banner (2).png" alt="" class="hero-img" />
      ...
      <div class="product-center container">
        <div class="product">
          ...
          <div class="product-footer">
            <a href="./product details/badminton-details.html">
              <h3>Badminton Light Weight</h3>
            </a>
            <div class="rating">
        ...
        <div class="product">
          ...
          <div class="product-footer">
            <a href="./product details/Shuttle-details.html"><h3>Shuttle Cock </h3></a>
            <div class="rating">
              <i class="bx bxs-star"></i>
              <i class="bx bxs-star"></i>
              <i class="bx bxs-star"></i>
        ...
        <div class="product">
          ...
          <div class="product-footer">
            <a href="./product details/cricket-gloves-details.html"><h3>Cricket Gloves</h3></a>
            <div class="rating">
              <i class="bx bxs-star"></i>
              <i class="bx bxs-star"></i>
              <i class="bx bxs-star"></i>
        ...
        <div class="product">
          ...
          <div class="product-footer">
            <a href="./product details/basket-ball-details.html"><h3>Basket Ball</h3></a>
            <div class="rating">
              <i class="bx bxs-star"></i>
              <i class="bx bxs-star"></i>
              <i class="bx bxs-star"></i>
    ...
    <section class="section featured">
      ...
      <div class="product-center container">
        ...
        <div class="product">
          ...
          <div class="product-footer">
            <a href="#"><h3>Best Squash Racquet</h3></a>
            <div class="rating">
              <i class="bx bxs-star"></i>
              <i class="bx bxs-star"></i>
              <i class="bx bxs-star"></i>
